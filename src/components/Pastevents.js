                        ...
                        <div className="flex flex-wrap mt-12 justify-center">
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                ...
                                <h6 className="text-xl mt-5 font-semibold text-gray-900">
                                    <a href="https://codecombat.com/" target="_blank" rel="noreferrer"> Code Combat
                                    </a>
                                </h6>
                                <p className="mt-2 mb-4 text-gray-900">
                                    Code Combat teaches the coding languages JavaScript and Python through the format of video games.
                                    Students program their avatar too get through the levels.
                                </p>
                            </div>
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                <div className="text-gray-900 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
                            ...
                            <div className="w-full lg:w-3/12 px-4 text-center">
                                ...
                                <h5 className="lg:text-xl mt-5 font-semibold textgray-900">
                                    <a href="https://scratch.mit.edu/" target="_blank" rel="noreferrer"> Scratch</a>
                                </h5>
                                <p className="mt-2 mb-4 text-gray-900">
                                    Scratch is a very popular website with a block-based programming language
                                    that allows children to create their own mini projects.
                                </p>
                            </div>
                        </div>
                    </div>
