            ...
            <div className="flex w-full min-h-full justify-center items-center" style={{ backgroundColor: '#F5F4F9' }}>
                <div className="p-4 min-w-full max-w-4xl" style={{ backgroundColor: '#F5F4F9' }}>
                                ...
                                <div className="lg:pt-12 pt-6 w-full md:w-3/4 px-4 text-center transform transition cursor-none hover:-translate-y-6">
                                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                        <div className="px-4 flex-auto">                                            
                                            ...
                                            <img className="m-6 block mx-auto sm:mx-0 sm:shrink-0" src="https://images.unsplash.com/photo-1515879218367-8466d910aaa4?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OTF8fHByb2dyYW1taW5nJTIwZm9yJTIwYWZyaWNhbiUyMGtpZHN8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt=""/>                       
                                ...
                                <div className="lg:pt-12 pt-6 w-full md:w-3/4 px-4 text-center transform transition cursor-none hover:-translate-y-6">
                                    <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-8 shadow-lg rounded-lg">
                                        <div className="px-4 flex-auto">                                            
                                            ...
                                            <img className="ml-6 block mx-auto sm:mx-0 sm:shrink-0" src="https://images.unsplash.com/photo-1485827404703-89b55fcc595e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGNoaWxkJTIwaW4lMjBpbmZvcm1hdGlvbiUyMHRlY2hub2xvZ3l8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="" />                                   
                                            <p className="mt-2 mb-8 text-gray-900 pt-6 pb-4">
                    ...
                    <div class="min-h-screen flex flex-row items-center justify-center bg-gray-100 transform transition cursor-none hover:-translate-y-6">                    
                        <div class="bg-blue-400 w-full shadow rounded max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-8 -mt-16 ">
                            <h1 className='text-center text-white lg:text-2xl text-lg font-semibold'>Our different programs is devided into 4 categories.</h1>
                            <ul class="flex flex-col lg:flex-row justify-between py-8 space-x-4 m-6">
                                <li class="flex items-center m-2 lg:text-lg font-medium  bg-gray-200 rounded-lg ">
