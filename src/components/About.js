        ...
        <div>
            ...
            <div className="flex w-full min-h-full justify-center items-center" style={{ backgroundColor: '#F5F4F9' }}>
                <div className="p-4 min-w-full max-w-4xl" style={{ backgroundColor: '#F5F4F9' }}>
                    {/* <h1 className="flex justify-center md:text-sm sm:text-sm lg:text-xl  font-bold ">About ChildTech</h1> */}
                    ...
                    <div class="max-w-5xl mx-auto px-6 sm:px-6 lg:px-8 mb-12 pt-96 transform transition cursor-none hover:-translate-y-12 ">
                        <div class="bg-blue-400 w-full justify-center shadow rounded p-8 sm:p-12 -mt-72">
                            ...
                            <h1 className='text-center text-white font-semibold lg:text-3xl p-8'>About ChildTech</h1>
                            <ul>
                                <li class="flex items-center space-x-2">
                                    ...
                                    <span className='p-2 lg:text-lg text-white'>ChildTech is a company that is going to teach children about technology.</span>
                                </li>
                                <li class="flex items-center space-x-2">
                                    <span> <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg> </span>
                                    <span className='p-2 lg:text-lg text-white'>This program will be having children from 7 years to 14 years, through ChildTech,
                                ...
                                <li class="flex items-center space-x-2">
                                    <span>   <svg class="w-10 h-10 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg> </span>
                                    <span className='p-2 lg:text-lg text-white'>ChildTech will be having several courses including the coding part,
                            ...
                            <div class="flex justify-between mt-8 text-white font-semibold max-w-3xl mx-auto">
                                <div class="inline-flex items-center">
                                    ...
                                    <span className=''>+(250) 785 262 657</span>
                                </div>
                                <div class="inline-flex items-center">
                                    <i class="fa fa-envelope" aria-hidden="true"></i>
                                    <span className=''>igiginixy10@gmail.com</span>
                                </div>                                
                                <div class="inline-flex items-center">
                                    <i class="fa fa-address-card" aria-hidden="true"></i>
                                    <span className=''>Kigali city, Gasabo, street KG 594 St</span>
                                </div>
                            </div>
                        </div>
                    </div>
